        ...
        _bindEvents: function () {
            ...
            this.events = {
                'click a': function (e) {
                    ...
                    if (checkElement.is('.sub-menu') && checkElement.is(':visible') && checkElement.children().length > 1) {
                    ...
                    else if ((checkElement.is('.sub-menu')) && (!checkElement.is(':visible')) && checkElement.children().length > 1) {
                        //Get the parent menu
