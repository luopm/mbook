...
!function () {
    $.widget('ui.intro', {
            ...
            if (this.options.steps) {
                ...
                for (var i = 0, stepsLength = this.options.steps.length; i < stepsLength; i++) {
                    ...
                    if (typeof (currentItem.element) === 'undefined' || currentItem.element == null) {
                        var floatingElementQuery = $(document).find(".ui-intro-floating-element");

                        if (floatingElementQuery.length === 0) {
                            floatingElementQuery = $('<div class="ui-intro-floating-element"></div>');
                            $('body').append(floatingElementQuery);
                        }
                    ...
                    currentItem.scrollToElement = currentItem.scrollToElement || this.options.scrollToElement;
        ...
        _showIntro: function (target) {
            ...
            var elementposition = this._getOffset(target.element);
            ...
            if (oldhelperlayer != null) { //已经存在引导提示框
                var $oldHelperLayer = $(oldhelperlayer),
                    ...
                    oldtooltiplayer = $oldHelperLayer.find('.ui-intro-tooltiptext'),
                ...
                //remove old classes
                var oldshowelement = $(document).find('.ui-intro-show-element');
                oldshowelement.removeClass('ui-intro-show-element ui-intro-relative-position');
                ...
                self._lastshowelementtimer = setTimeout(function () {
                    ...
                    oldtooltiplayer.html(target.intro);
                ...
                if (this.options.showStepNumbers) {
                    ...
                    this._placeToolTip(target.element, $toolTipLayer[0], $arrowlayer[0], null);
                }
        ...
        _exitIntro: function () {
            ...
            var showElement = $(document).find('.ui-intro-show-element');
            showElement.removeClass('ui-intro-show-element ui-intro-relative-position');
            ...
            if (fixParents && fixParents.length > 0) {
                for (var i = fixParents.length - 1; i >= 0; i--) {
                    fixParents[i].className = fixParents[i].className.replace(/ui-intro-fix-parent/g, '');
                }
            }
